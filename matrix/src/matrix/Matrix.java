...
public interface Matrix
{
	...
	/**
	* Add the argument matrix to <i>this</i> and return a new matrix containing the result.
	...
	*/
	...
	/**
	* Subtract the argument matrix from <i>this</i> and return a new matrix containing the result.
	* The matrices must match in size for the subtraction to succeed.
	* This is a generic method that can subtract matrices of any concrete implementation class.
	...
	*/
	...
	/**
	* Multiply the argument matrix with <i>this</i> and return a new matrix containing the result.
	* The matrices must have valid sizes for the multiplication to succeed. 
	* This is a generic method that can multiply matrices of any concrete implementation class.
